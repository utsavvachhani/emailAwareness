    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">Global Employee Directory</h1>
                    <p className="text-sm text-muted-foreground mt-0.5">Manage and view all employees across every registered company.</p>
                </div>
